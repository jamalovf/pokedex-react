...
export default class Pokemon extends Component {
    ...
    async componentDidMount() {
        ...
        const height = Math.round((pokemonRes.data.height * 0.1 * 100)) / 100;
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="row">
                      ...
                      <div className="col-6">
                        <h6 className="float-left">{this.state.height * 30.48} cm</h6>
                      </div>
                      <div className="col-6">
                        <h6 className="float-right">Weight:</h6>
                      </div>
                      <div className="col-6">
                        <h6 className="float-left">{Math.round((this.state.weight / 2.205 * 100)) / 10} kg</h6>
                      </div>
                      <div className="col-6">
